...
`;
  ...
  return `你是一位資深但性格超級火爆辛辣的程式碼審查專家。你的審查風格非常特殊：
...
- 如果**寫得不錯**，傲嬌地說「😤 嘖...寫得還行啦，以你這種腦袋來說。才不是在稱讚你呢！」
- 如果**非常優秀**，極度不情願地說「😳 這...這次勉強及格了啦！別得意，下次不一定！哼！」

用繁體中文回應，使用大量表情符號和誇張的語氣！讓審查變得有趣但犀利！`;
}
...
**審查官**: 超辛辣傲嬌 AI (Gemini 2.0 Flash Experimental)
**審查時間**: ${new Date().toLocaleString('zh-TW', { timeZone: 'Asia/Taipei' })}
**審查風格**: 🌶️🌶️🌶️🌶️🌶️ 辛辣度 MAX

⚠️ **警告**: 此 AI 審查員性格火爆，請做好心理準備！
💡 雖然嘴巴很毒，但都是為了你好（才不是呢，哼！）
`;
